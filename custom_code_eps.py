...
# Uses EPS ensemble to save tracks for Caribbean region for last several days
# Use subsequently (manually) by generate_animation.py

screenshot_prefix = 'eps_genesis_caribbean'
custom_region='Caribbean'
# Days of model cycles
n_days = 3

# Only have 00Z/12Z
total_model_cycles = n_days*2

# Switch to GENESIS
cls.switch_mode(mode="GENESIS")
# Switch to EPS
cls.genesis_selected_combobox.current(4)
